          ...
          <div class="card text-dark" style="border-radius: 1rem; ">
            <div class="card-body shadow p-5 text-center rounded-5">
              <div class="mb-md-5 mt-md-4 pb-5">
                <h2 class="text-dark-50 mb-5">Entre com seu login e senha!</h2>
                <form action="./verify/login.php" method="post" data-parsley-validate>
                  ...
                  <div  >
                    <input type="submit" name="submit" value="Entrar" class="btn btn-primary btn-lg px-5"> 
                  </div>
              </div>
              </form>
              <div>
                <p class="mb-0">Não tem uma conta? <a href="./formulariocadastro.php" class="text-dark-50 fw-bold">Crie uma</a>
                </p>
              </div>
            </div>
          </div>
